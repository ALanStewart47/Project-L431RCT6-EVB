...
void OLED_Init(void)
{
  ...
  HAL_GPIO_Init(OLED_CLK_PORT, &GPIO_InitStruct);
  ...
  HAL_GPIO_Init(OLED_SDA_PORT, &GPIO_InitStruct);
	...
	OLED_WR_Byte(0x22,OLED_CMD);//Set Pre-Charge as 15 Clocks & Discharge as 1 Clock
	
	OLED_WR_Byte(0xDA,OLED_CMD);//--set com pins hardware configuration
	OLED_WR_Byte(0x02,OLED_CMD);
	
	OLED_WR_Byte(0xDB,OLED_CMD);//--set vcomh
	OLED_WR_Byte(0x49,OLED_CMD);//Set VCOM Deselect Level
